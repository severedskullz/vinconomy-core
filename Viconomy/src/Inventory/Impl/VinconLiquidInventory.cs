...
{
    public class VinconLiquidInventory : VinconBaseInventory, IStallSlotUpdater
    {
        public VinconLiquidInventory(BEVinconBase stall, string inventoryID, ICoreAPI api, int numStalls, int numStacksPerStall) : base(stall, inventoryID, api, numStalls, numStacksPerStall)
        {
            InitializeStalls();
        }
        ...
        protected override ItemSlot NewSlot(int slotId)
        {
            ...
            return new VinconLockedSlot(this, stallSlot);
        }

...
{
    public class ViconItemPurchaseInventory : ViconBaseInventory, IStallSlotUpdater
    {
        ...
        public ViconItemPurchaseInventory(BEVinconBase stall, string inventoryID, ICoreAPI api, int numStalls, int productStacks, int purchasedStacks) : base(stall, inventoryID, api, numStalls, productStacks)
        {

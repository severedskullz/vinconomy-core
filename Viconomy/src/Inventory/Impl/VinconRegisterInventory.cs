...
{
    public class VinconRegisterInventory : InventoryGeneric
    {
        ItemSlot[] CouponSlots;
        VinconCurrencySlot TradePass;

        public int CurrencySlotCount => slots.Length;
        public int CouponSlotCount => CouponSlots.Length;
        public VinconRegisterInventory(int quantitySlots, int couponSlots, string invId, ICoreAPI api, NewSlotDelegate onNewSlot = null) : base(quantitySlots, invId, api, onNewSlot)
        {
            CouponSlots = GenEmptySlots(couponSlots);
            TradePass = new VinconCurrencySlot(this);
        }
        ...
        public override ItemSlot this[int slotId] {
            ...
            set
            {
                ...
                if (slotId == 0)
                    ...
                    TradePass = (VinconCurrencySlot) value;
                else if (slotId <= slots.Length)
                    // Remove 1 for TradePass;

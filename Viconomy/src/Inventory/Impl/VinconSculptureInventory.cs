...
{
    public class VinconSculptureInventory : InventoryBase, ISlotProvider
    {
        BEVinconBase stall;
        ...
        public VinconSculptureInventory(int numSlots, string inventoryID, ICoreAPI api) : base(inventoryID, api)
        {
        ...
        protected override ItemSlot NewSlot(int id)
        {
            if (id == 0)
                ...
                return new VinconSculptureBlockSlot(this, id);
        }

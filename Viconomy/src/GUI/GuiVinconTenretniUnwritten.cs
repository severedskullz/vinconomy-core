...
{
    public class GuiVinconTenretniUnwritten : GuiDialogGeneric
    {
        ...
        public GuiVinconTenretniUnwritten(string DialogTitle, ICoreClientAPI capi) : base(DialogTitle, capi)
        {

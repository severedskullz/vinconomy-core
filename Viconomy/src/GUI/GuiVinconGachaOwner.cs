...
{
    public class GuiVinconGachaOwner : GuiDialogBlockEntity
    {
        BEVinconGacha stall;
        ...
        public GuiVinconGachaOwner(string DialogTitle, VinconGachaInventory Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)
        ...
        private void Compose()
        {
            ...
            try { 
                ...
                SingleComposer = capi.Gui.CreateCompo("ViconStallOwner" + Inventory.InventoryID, dialogBounds)

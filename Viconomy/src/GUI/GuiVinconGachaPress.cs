...
{
    public class GuiVinconGachaPress : GuiDialogBlockEntity
    {
        BEVinconGachaLoader stall;
        InventoryBase vinInv;

        public GuiVinconGachaPress(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)

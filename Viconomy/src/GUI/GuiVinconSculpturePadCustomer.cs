...
{
    public class GuiVinconSculpturePadCustomer : GuiDialogBlockEntity
    {
        ...
        VinconCurrencySlot currancySlot;

        public GuiVinconSculpturePadCustomer(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)
            : base(DialogTitle, Inventory, BlockEntityPosition, capi)
        {
            ...
            currancySlot = new VinconCurrencySlot(inv);
        ...
        private void Compose()
        {
            ...
            VinconSculptureInventory vinInv = Inventory as VinconSculptureInventory;

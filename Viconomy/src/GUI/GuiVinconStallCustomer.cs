...
{
    public class GuiVinconStallCustomer : GuiDialogBlockEntity
    {
        ...
        public GuiVinconStallCustomer(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi, int stallSelection)
            : base(DialogTitle, Inventory, BlockEntityPosition, capi)
        {
            ...
            currancySlot = new VinconLockedSlot(inv,0);
        ...
        private void Compose()
        {
            ...
            SingleComposer = capi.Gui.CreateCompo("ViconStallCustomer"+Inventory.InventoryID, dialogBounds)
                ...
                SingleComposer.BeginChildElements(settingBounds)
                    ...
                    .AddItemSlotGrid(inv, null, 1, new int[] { 1 }, currencySlotBounds)

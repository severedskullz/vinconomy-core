    ...
    public class GuiVinconCatalog : GuiDialogGeneric
    {
        ...
        private void Compose()
        {
            ...
            try
            {
                ...
                Dictionary<string, ElementBounds>[] shopBoundsList = new Dictionary<string, ElementBounds>[shopList.Count];
                for (int i = 0; i < shopList.Count; i++)
                {
                    ...
                    ElementBounds shortDescLabel = locationLabel.BelowCopy().WithFixedSize(640, 20);
                ...
                for (int i = 0; i < shopList.Count; i++)
                {
                    ...
                    SingleComposer.AddRichtext("Shop Description", CairoFont.WhiteSmallText(), shop["shortDescLabel"]);
                    SingleComposer.AddButton("View", OpenShop, shop["openButton"]);
                }
                ...
                float scrollTotalHeight = 70 * shopList.Count;

...
{
    public class GuiVinconCouponCutter : GuiDialogBlockEntity
    {
        ...
        public GuiVinconCouponCutter(string dialogTitle, InventoryBase inventory, BlockPos pos, ICoreClientAPI coreClientAPI) : base(dialogTitle, inventory,  pos, coreClientAPI)
        {
        ...
        private void Compose()
        {
            ...
            try
            {
                ...
                SingleComposer = capi.Gui.CreateCompo("ViconCouponPrinter" + Inventory.InventoryID, dialogBounds)

...
{
    public class GuiDialogVinconGachaCustomer : GuiDialogBlockEntity
    {
        BEVinconGacha stall;
        VinconGachaInventory vinInv;
        DummyInventory inv;

        public GuiDialogVinconGachaCustomer(string DialogTitle, VinconGachaInventory Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)
            : base(DialogTitle, Inventory, BlockEntityPosition, capi)
        {
            ...
            this.inv[0] = new VinconCurrencySlot(inv);


            for (int i = 1; i < Inventory.Count; i++)
            {
                this.inv[i] = new VinconLockedSlot(inv, i);
            }

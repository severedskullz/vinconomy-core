...
{
    public class GuiVinconSculpturePadOwner : GuiDialogBlockEntity
    {
        BEVinconSculpturePad stall;
        VinconSculptureInventory vinInv;
        ...
        public GuiVinconSculpturePadOwner(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)
            : base(DialogTitle, Inventory, BlockEntityPosition, capi)
        {
            ...
            vinInv = Inventory as VinconSculptureInventory;
        ...
        private void Compose()
        {
            ...
            try { 
                ...
                for (int iregister = 0; iregister < registers.Length; iregister++)
                {
                    ...
                    if (stall.ShopId == registers[iregister].ID)
                    {
                ...
                SingleComposer.BeginChildElements(itemPage)
                    ...
                    .AddButton(">", new ActionConsumable(this.NextLayer), pageNext, EnumButtonStyle.Small, "nextPage");
                        ...
                        for (int z = 0; z < slotBounds.Length; z++)
                        {
                            ...
                            {
                                VinconSculptureBlockSlot iSlot = stall.GetSlotForGrid(x, curTab, z);
                                if (iSlot.isDisabled)
                                {
